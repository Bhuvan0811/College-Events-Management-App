            ...
            <div className="event-main flex flex-wrap justify-evenly">
              {popularEvents.map((ele) => {
                return (
                  ...
                  <EventCard key={ele._id} userPage={userPage} setUserPage={updateUserPage} dataToFetch={ele.eventName} eventName={ele.eventName.charAt(0).toUpperCase() + ele.eventName.slice(1)} date={ele.startDate} eventCategory={ele.eventType} eventImage={ele.eventImage} />
                )
              })}
